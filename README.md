# Jamstack personal portfolio - starter files

## Original Project

Below is a description of the original project from the author.
...
You can [watch this video](https://youtu.be/4wD00RT6d-g) to see how Kevin uses Eleventy, Netlify, and Netlify CMS to create a full-featured portfolio site built entirely with static files.
